...
<table border=0 width=550 cellspacing=0 cellpadding=0 bgcolor=#F0F0F0 align=<?= $tbalign; ?>>
    ...
    <tr>
        ...
        <td><input type=text name=subject value='<? echo "[RE] $subject"; ?>' size=72 maxlength=200></td>
    </tr>
    <tr>
        <td bgcolor=white height=1 colspan=2></td>
    </tr>
    ...
    if ($attach == 'Y') { // 파일 첨부 기능이 있을 경우에 사용함. 이 조건문은 그대로 사용해야 합니다.
        ...
        <tr>
            ...
            <td><input type="file" name="upfile" size="56"><br>
            </td>
        </tr>
        <?
    }
...
<br>
<center>
    <?= $a_submit; ?><img src="<?= $skindir ?>/reply.gif" border="0" align=absmiddle></a> &nbsp;&nbsp;
